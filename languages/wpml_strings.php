...
"Animation Time",
"Duration (in seconds) of the pan/zoom animation, lower values increase animation speed. ",
...
"Load More",
"When 'Paged Result' is active (and a value is set in the 'Maximum' field), enabling this option will replace the pager element with a single 'Load More' button. Once clicked, it will load new items in the background and add them to the current page.",
"Portfolio Columns",
...
"Blog",
"Inline Videos",
"If enabled, display a video player for video format posts.",
"Inline Sliders",
"If enabled, display a slider for gallery format posts.",
"Column Width",
"Image Height",
"Slider images height.",
"Crop Featured Image",
"When 'Image Height' is set, only slider images are cropped, set this option to 'yes' to also crop featured images.",
"Layout - Manager",
"Layout Manager",
"Text",
...
"Usually, text content has a maximum width set (which depends on the theme but usually around 940px) and gets centered. Use 'Full Width' settings if you want the block to fill the whole container, for instance to add full width content using a shortcode.",
...
"Add one or more testimonial. If none selected, all available testimonials will be shown.",
"Use this block to add a testimonial module to your layout, testimonial items are created separately.",
"Tabs",
"UI",
...
"Stats",
"Use this block to add a stats module to your layout. This consists of a variable number of stat columns each holding a title, image and text content.",
"Stat",
"Stat title.",
"Image",
"Stat image.",
"Stat content.",
"Use this block to add an additional stat column of data to the stats module.",
"Staff",
"Meet the Team",
"Text Position",
...
"Skill 2",
"Skill 3",
"Use this block to add feature block to your layout. This consists of text content with an optional action button and a single image",
"Services",
"Our Services",
"Add one or more service. If none selected, all available services will be shown.",
"Use this block to add a services module to your layout, service items are created separately.",
"Section",
"Section Title.",
"Link Name",
"Used when linking to the section in a page (eg, from the menu).",
"Section color style, use 'light' for light backgrounds (like white)",
"Light",
"Dark",
"Top Padding",
"Section top padding.",
...
"Structure",
"section",
"Use this block to add sections to the one page layout.",
"Pricing Table",
"Show Labels",
...
"Show Caption",
"Whether to show title/description under the image/video or not.",
"Use this block to show a gallery as a Carousel.",
"Contact Form",
...
"Add warning box",
"Add a View",
"Invalid View ID, make sure to generate shortcode using provided shortcode generator and not by copy-pasting.",
"MEDIA",
"LAYOUT",
"Testimonial",
...
"Only include items assigned to the selected ",
"Order",
"Choose in which order will data display. Note that this is ignored if Selection is used.",
"Ascending",
"Descending",
"Order By",
"Choose by which criteria will data display. Note that this is ignored if Selection is used.",
"ID",
"Author",
"Date",
"Data Type",
...
"Used as project title when shown inside a portfolio section, leave empty to use project title.",
"Used as project description when shown inside a portfolio section, leave empty to hide.",
...
"Advanced",
"Enables  \"Load More\" feature in default blog archives, tags and category pages. Ignored in Views since they have a dedicated option to activate the feature.",
"Save Builder in Editor",
"If enabled, the page builder content will replace editor content when saving the page. Plugins like Yoast SEO will be then able to access builder content as well.",
"Lazy Loading",
...
"Sticky Footer",
"Sticky footer is only supported in fullwidth pages where template is set to 'builder'.",
"This is the footer logo image. The image should be a .png file.",
"Copyright",
"This is the footer copyright message.",
"Custom Colors",
"In this page you can set alternative colors for the main colored elements in this theme. The colored elements available to be changed are listed below. To change the colors used in these areas simply write a new hex color reference number into the fields below or use the color picker which appears when each field obtains focus. Once you have selected your desired colors make sure to save them by clicking the <b>Save All Changes</b> button at the bottom of the page. Then just refresh your page to see the changes. To reset a color to it's default simply click the 'Default' button in the color picker.",
"Custom Fonts",
...
"Use Youtube Video",
"Whether to show a youtube video as page background.",
"YouTube Videos",
"Add one or more youtube video urls.",
"Fallback Image",
"Fallback image used for mobile and browsers lacking video playback feature.",
"Home Page Settings",
"Splash Section",
"Whether to show the home splash section or not.",
"Min Height",
"Minimum height (in pixel) of the splash section. Values lesser than 300 could be ignored to make sure the splash section is visible on mobile.",
"Max Height",
"Maximum height (in pixel) of the splash section, when 0 is used, the section will extend to fill the whole page.",
"Select the menu bar type.",
"Transparent",
"Select a slider view to be used in home splash section.",
"Logo.",
"Logo Offset",
"Logo distance (in pixel) from the splash section center. 0 means centered, a negative value will move logo up (towards the header) while a positive value will do the opposite.",
"Label text to show when overing the logo.",
"START HERE",
"Logo link.",
"Taglines",
"Add one or more taglines.",
"Tagline %",
"By",
"Tag: %s",
"Our Blog",
